...
health, shield, score, round_num = 100, 0, 100, 1
...
#sound effect
gun_sounds = {
    "pistol": pygame.mixer.Sound("C:/Users/nickh77/Downloads/Zombie-Hunter-main/website/game-showcase/src/assets/sounds/pistol.mp3"),
    "assault_rifle": pygame.mixer.Sound("C:/Users/nickh77/Downloads/Zombie-Hunter-main/website/game-showcase/src/assets/sounds/assault_rifle.mp3"),
    "shotgun": pygame.mixer.Sound("C:/Users/nickh77/Downloads/Zombie-Hunter-main/website/game-showcase/src/assets/sounds/shotgun.mp3"),
}
...
def reset_game():
    ...
    health, shield, score, round_num = 100, 0, 100, 1  # Start with 100 points
    stamina = max_stamina
    zombies, bullets, active_powerups = [], [], []
    gun_type = "pistol"
    current_ammo = ammo[gun_type]
